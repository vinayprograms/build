...
- [x] **Implement parser scope stack**
  ...
  - [x] Update `cmd/need` CLI to incorporate new feature including updates to all test cases of the CLI.
...
- [x] **Implement environment selection**
  ...
  - [x] `NEED_ENV` environment variable second
...
- [x] **Implement option flags**
  ...
  - [x] `--file path` / `-f path` → alternate Needfile
...
- [x] **Implement Needfile discovery**
  - [x] Look for `Needfile` in current directory
...
- [x] **Define exit codes**
  ...
  - [x] 3 → parse error (invalid Needfile)
...
- [x] **Write migration guide**
  - [x] Make to Needfile translation
  - [x] Common patterns
...
- [x] **Implement OutputMode detection**
  ...
  - [x] Support NEED_OUTPUT_MODE override
