...
// NeedfileResult represents the result of parsing a complete needfile.
type NeedfileResult interface {
...
type NeedfileParser interface {
	// ParseNeedfile parses the complete needfile with error recovery.
	// Returns statements and errors. Parsing continues after errors to collect
	// as many valid statements as possible.
	ParseNeedfile() NeedfileResult
}
