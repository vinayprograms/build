...
// NeedfileCache caches parsed Needfile ASTs keyed by absolute path.
...
func NewNeedfileCache() *NeedfileCache {
	return &NeedfileCache{
...
func (c *NeedfileCache) Put(path string, statements []ast.Statement) error {
...
func (c *NeedfileCache) Get(path string) ([]ast.Statement, bool, error) {
	absPath, err := filepath.Abs(path)
	if err != nil {
...
func (c *NeedfileCache) Invalidate(path string) {
